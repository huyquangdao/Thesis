...
class Token:
    ...
    def __str__(self):
        return 'content:{}, doc_offset: {}, sent_offset: {}'.format(self.content,self.doc_offset,self.sent_offset)
...
class Sentence:
    ...
    def __str__(self):
        ...
        return 'content: {}, doc_offset: {}'.format(self.content,self.doc_offset)
...
class Document:
    ...
    def __str__(self):
        ...
        return 'id: {}, content: {}, length sentences:{}, meta_data:{}'.format(self.id,
                                                                               self.content,
                                                                               self.sentences,
                                                                               self.metadata)
...
class BioEntity(Entity):
    ...
    def __str__(self):
        ...
        return 'tokens: {0}, ids: {1}'.format(self.tokens,self.ids)
